...
ingredients:
  ...
  - item: 1.5 cups chopped onion (one medium)
  - item: 1.5 cups chopped green/red bell pepper (one medium)
  - item: 2 pounds lean-ish (85/15 or 90/10) ground beef
  - item: 6 cloves garlic, chopped
  - item: 1dried bay leaf
  - item: 1/2 tsp cumin
  - item: 1/4 cup dry sherry plus a splash
  - item: 2 tbsp tomato paste
  - item:
      1beef bouillon cube dissolved in 1/2 cup warm water (the aforementioned
      beefy trick)
  - item: 20 or so pimento stuffed, manzanilla olives cut in half
  - item: 20-30raisins (golden are fine)
  - item: 1+ tsp salt
  - item: 1/2 cup Peti Pua
  - item: 1 dozen capers
directions:
  - step: >-
