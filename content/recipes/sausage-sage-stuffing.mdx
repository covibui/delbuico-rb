...
ingredients:
  ...
  - item: 8 cups chicken or turkey stock (the original recipe calls for 3-4 cups,
...
directions:
  - step: >-
      ...
      2. Dice the bacon, onions, and celery and place all of it into a large, deep skillet with sausage.  Cook until thoroughly browned, 30-45 minutes.  Drain the fat off occasionally as it cooks.  When fully cooked, drain the remaining fat.  Transfer the drained mixture to a large bowl.  Do not wash the skillet. 

      3. Melt butter in the same skillet.  Add 1 cup of 

         [stock](https://nocrumbsleft.net/2016/11/18/turkey-stock/)

          and heat to a simmer, scraping up the brown bits from the bottom of the skillet.  Cool slightly. 
